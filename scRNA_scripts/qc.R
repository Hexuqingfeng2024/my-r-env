basic_qc <- function(input_sce){
  ...
  ggsave(filename="Vlnplot1.pdf",plot=p1,width = 14,height = 7)
  ...
  ggsave(filename="Vlnplot2.pdf",plot=p2,width = 14,height = 7)
  ...
  ggsave(filename="Vlnplot1_filtered.pdf",plot=p1_filtered,width = 15,height = 7)
  ...
  ggsave(filename="Vlnplot2_filtered.pdf",plot=p2_filtered,width = 15,height = 7) 
